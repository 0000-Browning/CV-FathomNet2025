...
if __name__ == "__main__":
    ...
    transform = transforms.Compose(
        [
            ...
            transforms.GaussianBlur(kernel_size=3, sigma=(0.1, 2.0)),  # Apply Gaussian filter with kernel size 3
    ...
    for epoch in range(epochs):
        ...
        # Early stopping logic (only if early_stop is True)
        if early_stop:
